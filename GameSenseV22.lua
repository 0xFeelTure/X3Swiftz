...
local Library = {
    ...
    FontColor = Color3.fromRGB(227, 227, 227);
    MainColor = Color3.fromRGB(46, 46, 46);
    BackgroundColor = Color3.fromRGB(34, 34, 34);
    AccentColor = Color3.fromRGB(108, 195, 17);
    OutlineColor = Color3.fromRGB(34, 34, 35);
...
Library.AccentColorDark = Library:GetDarkerColor(Color3.fromRGB(108, 195, 17));
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local Highlight = Library:Create('Frame', {
            BackgroundColor3 = Color3.fromRGB(108, 195, 17);
            BorderSizePixel = 0;
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        for Idx, Mode in next, Modes do
            ...
            function ModeButton:Select()
                ...
                Label.TextColor3 = Color3.fromRGB(108, 195, 17);
        ...
        function KeyPicker:Update()
            ...
            ContainerLabel.TextColor3 = State and Color3.fromRGB(108, 195, 17) or Library.FontColor;
...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        function Toggle:Display()
            ToggleInner.BackgroundColor3 = Toggle.Value and Color3.fromRGB(108, 195, 17) or Library.MainColor;
            ToggleInner.BorderColor3 = Toggle.Value and Color3.fromRGB(108, 195, 17) or Library.OutlineColor;
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local Scrolling = Library:Create('ScrollingFrame', {
            ...
            ScrollBarImageColor3 = Color3.fromRGB(108, 195, 17), 
        });
...
do
    ...
    local WatermarkInner = Library:Create('Frame', {
        BackgroundColor3 = Library.MainColor;
        BorderColor3 = Color3.fromRGB(108, 195, 17);
        BorderMode = Enum.BorderMode.Inset;
        Size = UDim2.new(1, 0, 1, 0);
        ZIndex = 201;
...
function Library:CreateWindow(...)
    ...
    function Library.Toggle()
        ...
        while Outer.Visible and ScreenGui.Parent do
            ...
            Cursor.Color = Color3.fromRGB(108, 195, 17);
