...
local Library = {
    ...
    AccentColor = Color3.fromRGB(63, 243, 255);
...
Library.AccentColorDark = Library:GetDarkerColor(LColor3.fromRGB(150, 255, 201));
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local Highlight = Library:Create('Frame', {
            BackgroundColor3 = Color3.fromRGB(150, 255, 201);
            BorderSizePixel = 0;
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        for Idx, Mode in next, Modes do
            ...
            function ModeButton:Select()
                ...
                Label.TextColor3 = Color3.fromRGB(150, 255, 201);
        ...
        function KeyPicker:Update()
            ...
            ContainerLabel.TextColor3 = State and Color3.fromRGB(150, 255, 201) or Library.FontColor;
...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        function Toggle:Display()
            ToggleInner.BackgroundColor3 = Toggle.Value and Color3.fromRGB(150, 255, 201) or Library.MainColor;
            ToggleInner.BorderColor3 = Toggle.Value and Color3.fromRGB(150, 255, 201) or Library.OutlineColor;
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local Scrolling = Library:Create('ScrollingFrame', {
            ...
            ScrollBarImageColor3 = Color3.fromRGB(150, 255, 201), 
        });
...
do
    ...
    local WatermarkInner = Library:Create('Frame', {
        BackgroundColor3 = Library.MainColor;
        BorderColor3 = Color3.fromRGB(150, 255, 201);
        BorderMode = Enum.BorderMode.Inset;
        Size = UDim2.new(1, 0, 1, 0);
        ZIndex = 201;
...
function Library:CreateWindow(...)
    ...
    function Library.Toggle()
        ...
        while Outer.Visible and ScreenGui.Parent do
            ...
            Cursor.Color = Color3.fromRGB(150, 255, 201);
